                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0">
                                <i class="fas fa-plus-circle text-primary me-2"></i>Add New Evacuation Site
                            </h5>
                            <a href="{{ route('evacsites.index') }}" class="btn btn-outline-secondary btn-sm">
                                <i class="fas fa-arrow-left me-1"></i> Back
                            </a>
                        </div>
                        
                        <form action="{{ route('evacsites.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="card mb-3 border-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="sitename" name="sitename" value="{{ old('sitename') }}" required>
                                            </div>
                                            
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="lat" class="form-label">Latitude</label>
                                                    <input type="number" step="any" class="form-control" id="lat" name="lat" value="{{ old('lat') }}" required min="-90" max="90" placeholder="e.g. 14.5995">
                                                    <small class="text-muted">Between -90 and 90</small>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="lang" class="form-label">Longitude</label>
                                                    <input type="number" step="any" class="form-control" id="lang" name="lang" value="{{ old('lang') }}" required min="-180" max="180" placeholder="e.g. 120.9842">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="room" name="room" value="{{ old('room') }}" min="1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="powerstatus" name="powerstatus" required>
                                                        <option value="available" {{ old('powerstatus') == 'available' ? 'selected' : '' }}>Available</option>
                                                        <option value="unavailable" {{ old('powerstatus') == 'unavailable' ? 'selected' : '' }}>Unavailable</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="waterstatus" name="waterstatus" required>
                                                        <option value="available" {{ old('waterstatus') == 'available' ? 'selected' : '' }}>Available</option>
                                                        <option value="unavailable" {{ old('waterstatus') == 'unavailable' ? 'selected' : '' }}>Unavailable</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="medicine_qty" name="medicine_qty" value="{{ old('medicine_qty') }}" min="1" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="toiletries_qty" class="form-label">Toiletries Quantity</label>
                                                    <input type="number" class="form-control" id="toiletries_qty" name="toiletries_qty" value="{{ old('toiletries_qty') }}" min="1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="relief_goods_qty" name="relief_goods_qty" value="{{ old('relief_goods_qty') }}" min="1" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="beddings_qty" class="form-label">Beddings Quantity</label>
                                                    <input type="number" class="form-control" id="beddings_qty" name="beddings_qty" value="{{ old('beddings_qty') }}" min="1" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-primary px-4 py-2">
                                        <i class="fas fa-save me-2"></i>Save Evacuation Site
                                    </button>
